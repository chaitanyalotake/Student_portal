    ...
    <body>
        ...
        <table cellspacing="100">
          <tr>
            ...
            <td>
                  <select name="select_state" id="state" class="text">
                    ...
                    <option value="Kerala" name="chaitanya">Kerala</option>
        ...
        <tr>
         ...
         <td>
           <select name="select_university" id="meal" onchange="changeCat(this);">
...
echo $select_state;
$query = mysqli_query($connection,"insert into complaints(complaints_description,select_state) values ('$complaints_description','$select_state')");
